                ...
                <Container className="mb-6">
                    ...
                    <Row md={2} className="g-4">
                        <Card
                            order={0}
                            isPrimary
                            heading="Вызов технических служб"
                            image={whiteRem}
                        >
                    ...
                    <Row md={2} className="g-4">
                        ...
                        <Col xs="12" md="9" className="d-inline-flex justify-content-center">
                            <p className="lead">
                                ...
                                добавлением нового функционала. Если вы хотите помочь нам, то пишите
                                на <a href="mailto:support@cyberdas.net">support@cyberdas.net</a>{' '}
                                или присоединяйтесь к{' '}
